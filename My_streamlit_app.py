...
st.pyplot(fig2);
st.text('When the horsepower is higher, the lowest time the car will take to achieve 60kmh') 
...
st.pyplot(fig3);
st.text('The lighest the car is, the more miles it can achieve per mile') 
